"""
    Credit to LanguageModel from AllenNLP
    Reference: https://github.com/allenai/allennlp/blob/v1.0-prerelease/allennlp/models/language_model.py
"""
...
class HyperbolicTunedLanguageModel(Model):
    """
    ...
    def forward(  # type: ignore
        ...
        if token_ids is not None:
            ...
            total_loss = average_loss + hyperbolic_encoding_loss * self._hyperbolic_weight
            ...
            if num_targets > 0:
                ...
                return_dict.update({"loss": total_loss, "forward_loss": total_loss})
                if backward_loss is not None:
                    return_dict["backward_loss"] = total_loss
