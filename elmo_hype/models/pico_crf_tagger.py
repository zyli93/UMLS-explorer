...
def get_pico_label_vocab():
    ...
    labels = [Instance({'label': LabelField(l, label_namespace='labels')}) for l in labels]
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        ...
        for metric_name, metric_obj in self.metrics.items():
            if metric_name.startswith('accuracy'):
                ...
                f1_metrics = metric_obj.get_metric(reset)
                p, r, f1 = f1_metrics['precision'], f1_metrics['recall'], f1_metrics['f1']
